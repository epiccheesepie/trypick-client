			...
			<div className="item-search__content">
				...
				<div className="item-search__info">
					<div className="info__text">
						...
						<div className="info__item">
							<span className="info__static">Бюджет:</span>
							<span className="info__changed">${budget}</span>
						</div>
                        <div className="info__item">
							<a className="rate__kinop" href={linkKP}>Фильм на КиноПоиске</a>
						</div>
						<div className="info__item info__descrip">
